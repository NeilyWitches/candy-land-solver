...
class Board:
    ...
    def generate_board(self) -> List[BoardSpace]:
        ...
        board.append(TreatSpace(Treat.CANDY_CANE))
        ...
        board.append(ShortcutSpace(Shortcut.GUMDROP_PASS))
        ...
        board.append(TreatSpace(Treat.GUMDROP))
        ...
        board.append(TreatSpace(Treat.NUT))
        ...
        board.append(TreatSpace(Treat.LOLLIPOP))
        ...
        board.append(TreatSpace(Treat.FROST))
